...
s5_kwargs = {"use_parallel_scan":True,
             "initialization":HippoDiagonalizedInitializer(scale=1),
             "discretization_method":'zoh',
             "dt_range":(1, 0.1)}


model_kwargs = ModelParams(base_model=S5,
                           base_model_kwargs=s5_kwargs,
                           N=[6, 6, 6, 6],
                           H=3,
